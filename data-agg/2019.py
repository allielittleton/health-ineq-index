...
def analyze(df):
    ...
    return abs_dev, standard_dev, AaD_mode, under_5_mortality
...
def main():
    ...
    input_df = pd.read_excel('Country_Data_2019.xlsx')
    ...
    income_class_data = pd.read_excel('Income_Sorting_Data_1.xlsx')
    ...
    output_df1.to_excel("Inequality Index Values 04-6.xlsx")

    #output_df2 = output_df.sort_values(by=['Standard Deviation Index Value'])
    #output_df2.to_excel("Inequality Index Values by Country 2019 (sorted by stand. dev).xlsx")
